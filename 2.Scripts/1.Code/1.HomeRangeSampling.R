...
Sampled_Rasters <-sample(RasterFilepaths,2300,replace = F)
...
# Running Sampler in parallel with future lapply
plan("multiprocess", workers = 4)

HR_Sampling<-future_lapply(Sampled_Rasters,
                            HR_Sampler,
                            BaseAgg_size = 30,
...
HR_Samples <- do.call(rbind,HR_Sampling)
