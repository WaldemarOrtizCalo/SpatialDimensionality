RasterCalculations_DISAGG<-function(Raster,sample.size){
  tryCatch({# Reproject Raster To UTM
    ...
    Raster_Reprojected <- disaggregate(Raster_Reprojected, fact = c(FactorCalculator2(xres(Raster_Reprojected),FactorCalculator2(yres(Raster_Reprojected)))))
